...
import HighlightDataPointSettings from './PageSections/ComplexDataTypes/HighlightDataPointSettings.mdx';
...
__Please note: If your would like to use GeoHub maps or 3-D graph please use `SingleGraphDashboardGeoHubMaps` or `SingleGraphDashboardThreeDGraphs` respectively instead of `SingleGraphDashboard`__
...
- [highlightDataPointSettings](#highlightdatapointsettings) - Settings to define which data points are highlighted
